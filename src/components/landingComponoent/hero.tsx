  ...
  return (
    <div className='text-white'>
        <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            ...
            <p className='md:text-2xl text-xl font-bold text-gray-600 pt-4'>Stop worrying about exchange rates and hidden fees. Our platform makes sending and receiving international payments straightforward, fast, and secure. Get the best rates for your transactions.</p>
