...
// Define User type based on your backend User model (simplified for transactions)
interface User {
  _id: string;
  firstName: string;
  lastName: string;
...
// Define Transaction type matching your backend transaction model
export interface Transaction {
  _id: string;
  userId: User | null;
  transactionType: "deposit" | "withdrawal" | "cryptowithdrawal" | "bankdeposit";
            ...
            <form onSubmit={handleUpdateStatus} className="space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSelectedTx({ ...selectedTx, status: e.target.value as Transaction["status"] })
                  }
                >
