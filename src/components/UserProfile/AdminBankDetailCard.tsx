...
export default function AdminBankDetailCard() {
  ...
  // ✅ Fetch bank details immediately when component mounts
  useEffect(() => {
    fetchBankDetail();
  }, []);
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
      <div className="flex flex-col h-full">
        ...
        {/* ✅ Automatically show details once loaded */}
        {loading ? (
          <p className="text-blue-500 mt-3">Loading bank details...</p>
        ) : error ? (
          ...
          <div className="mt-3 text-sm text-gray-600 dark:text-gray-300 space-y-1">
            ...
            <p>
              <strong>Account No:</strong> {form.accountNumber}
            </p>
            <p>
              <strong>Account Holder:</strong> {form.accountHolderName}
            </p>
            <p>
              <strong>Fee per USDT:</strong> {form.feePerUSDT}
            </p>
            <p>
              <strong>USDT Rate:</strong> {form.usdtRate}
            </p>
          </div>
        ) : (
          <p className="text-gray-500 mt-3">No bank details found.</p>
        )}
